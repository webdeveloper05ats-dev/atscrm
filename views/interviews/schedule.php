...
function renderHrStudentDetailHtml(array $detail): string
{
    ...
    <div class="hrd-wrap">
        ...
        <div class="hrd-section">
            ...
            <div class="hrd-grid hrd-grid-two">
                <div class="hrd-card"><div class="hrd-title">Final Fee</div><div class="hrd-value"><?= inr_symbol() ?> <?= interviewWorkflowH(number_format((float) ($student['final_fee'] ?? 0), 2)) ?></div></div>
                <div class="hrd-card"><div class="hrd-title">Paid</div><div class="hrd-value"><?= inr_symbol() ?> <?= interviewWorkflowH(number_format((float) ($student['paid_amount'] ?? 0), 2)) ?></div></div>
                <div class="hrd-card"><div class="hrd-title">Balance</div><div class="hrd-value"><?= inr_symbol() ?> <?= interviewWorkflowH(number_format((float) ($student['balance_amount'] ?? 0), 2)) ?></div></div>
                        ...
                        <tbody>
                            <?php foreach ($payments as $payment): ?>
                                <tr>
                                    ...
                                    <td><?= inr_symbol() ?> <?= interviewWorkflowH(number_format((float) ($payment['amount'] ?? 0), 2)) ?></td>
