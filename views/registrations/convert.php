            ...
            <div class="reg-group-card reg-step-panel" id="regStep5" data-step="5">
              ...
              <div class="reg-fee-strip">
                <div class="reg-fee-box">
                  ...
                  <div class="fee-value"><?= inr_symbol() ?> <span id="previewTotalFee"><?= h(number_format((float)$total_fee, 2, '.', '')) ?></span></div>
                </div>

                <div class="reg-fee-box">
                  <div class="fee-label">Discount</div>
                  <div class="fee-value"><?= inr_symbol() ?> <span id="previewDiscountFee"><?= h(number_format((float)$discount_amount, 2, '.', '')) ?></span></div>
                </div>

                <div class="reg-fee-box">
                  <div class="fee-label">Final Fee</div>
                  <div class="fee-value"><?= inr_symbol() ?> <span id="previewFinalFee"><?= h(number_format((float)$final_fee, 2, '.', '')) ?></span></div>
                </div>
              </div>
              <div class="reg-step-nav">
