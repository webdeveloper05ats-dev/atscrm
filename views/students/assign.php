...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['assign_student'])) {
    ...
    try {
        ...
        $upd = $pdo->prepare("
            ...
            LIMIT 1
        ");
        $upd->execute([$staffId, $registrationId]);
...
.stu-assign-form{ display:flex; gap:8px; align-items:center; justify-content:center; }
.stu-assign-form select{ min-width:170px; }
...
@media (max-width: 900px){
  .stu-filter-row{ grid-template-columns:1fr; }
  .stu-assign-form{ flex-direction:column; align-items:stretch; }
  .stu-assign-form select{ min-width:unset; }
}
</style>
        ...
        <form method="GET" action="index.php" style="padding:14px;">
            ...
            <div class="stu-filter-row">
                ...
                <div style="display:flex; gap:8px;">
                    ...
                    <a href="index.php?page=students/assign" class="btn" style="background:#f3f4f6;"><i class="fas fa-undo"></i> Reset</a>
                </div>
            </div>
        </form>
    </div>
